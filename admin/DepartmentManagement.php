...
<html lang="en">
<head>
    <title>Department Management | MCF</title>
...
<div class="app-wrapper">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Department Management</h1>
                </div>

                <div class="tab-content" id="departments-table-tab-content">
                    <!-- Add this section below the employees' table -->
                    <div class="tab-pane fade show active" id="departments" role="tabpanel" aria-labelledby="departments-tab">
                        <div class="app-card app-card-departments-table shadow-sm mb-5">
                    ...
                    </div><!--//tab-pane-->                    <!-- Additional tab panes for specific categories if needed -->
                </div><!--//tab-content-->
    ...
    <script>
        ...
        function deleteDepartment(departmentId) {
            ...
            // For example, you can remove the department from the departmentsData array
